 ...
 *   );
 *
 * . $trackingRequest = new TrackOrderRequest();
 *   $trackingRequest->initialize($data);
 *
 *   // Do a tracking request
 *   try {
 ...
 */
class TrackOrderRequest extends SendyRestRequest
{
    ...
    {
        return parent::getEndpoint() . '/orders/' . $this->data['orderNumber'];
    }
}
